...
public class VideoView extends SurfaceView implements MediaPlayerControl {
	...
	public void setVideoUrl(String path1) {
		System.out.println("setVideoUrl============>" + path1);
		path = path1;
	...
	MediaPlayer.OnPreparedListener mPreparedListener = new MediaPlayer.OnPreparedListener() {
		public void onPrepared(MediaPlayer mp) {
			...
			mVideoWidth = mp.getVideoWidth();
			mVideoHeight = mp.getVideoHeight();
			Log.d("Video ----->", "width:" + mVideoWidth + "   height:"
					+ mVideoHeight);
			if (mVideoWidth != 0 && mVideoHeight != 0) {
	...
	SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
		...
		public void surfaceCreated(SurfaceHolder holder) {
			...
			Log.w(TAG, "media-->surfaceCreated");
			openVideo();
		}
		...
		public void surfaceDestroyed(SurfaceHolder holder) {
			...
			if (mMediaController != null)
				mMediaController.hide();
			Log.w(TAG, "media-->surfaceDestroy");
			try {
				if (mMediaPlayer != null) {
					mMediaPlayer.reset();
					mMediaPlayer.release();
	...
	public synchronized void mediaRelease() {
		if (mMediaPlayer != null) {
